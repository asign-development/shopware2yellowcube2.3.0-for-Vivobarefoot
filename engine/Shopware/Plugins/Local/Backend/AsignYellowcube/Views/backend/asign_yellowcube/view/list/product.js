...
Ext.define('Shopware.apps.AsignYellowcube.view.list.Product', {
    ...
    snippets: {
        ...
        columnNumber: '{s namespace="backend/asign_yellowcube/main" name=yellowcube/grid/articles/number}Article Nr.{/s}',
        columnYcNumber: '{s namespace="backend/asign_yellowcube/main" name=yellowcube/grid/inventory/ycnumber}Ycube Artnum{/s}',
        columnEAN: '{s namespace="backend/asign_yellowcube/main" name=yellowcube/grid/articles/ean}EAN{/s}',
        columnYCStock: '{s namespace="backend/asign_yellowcube/main" name=yellowcube/grid/articles/ycstock}Ycube Stock{/s}',
    ...
    getColumns: function () {
        ...
        var columns = [
            ...
            {
                header: me.snippets.columnYCStock,
