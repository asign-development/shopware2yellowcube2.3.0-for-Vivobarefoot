    ...
    <div id="header">
        ...
        <div id="head_right" style="margin-top:50px;">
            {block name="document_index_head_right"}
                ...
                <small><u>{s name=ConfirmHeaderShipping}Lieferadresse{/s}</u></small>
                <br/>
                ...
                <br/>
                <br/>
                {s name="DocumentIndexCustomerID"}Kunden-Nr.:{/s} {$User.billing.customernumber|string_format:"%06d"}
                <br/>
                {if $User.billing.ustid}
                    {s name="DocumentIndexUstID"}USt-IdNr.:{/s} {$User.billing.ustid|replace:" ":""|replace:"-":""}
                    <br/>
                {/if}
                {s name="DocumentIndexOrderID"}Bestell-Nr.:{/s} {$Order._order.ordernumber}
                <br/>
                    ...
                    <tr>
                        ...
                        {block name="document_index_table_name"}
                            <td align="left" width="48%" valign="top">
                                ...
                                {if $isForeignCountry}
                                    <br/>
                                    <strong>{s name=yellowcube/details/articles/form/tariff}Commodity Code{/s}</strong>
                                    : {$position.tariff}
                                    <br/>
                                    <strong>{s name=yellowcube/details/articles/form/tara}Tara{/s}</strong>
                                    : {$position.tara} Kg
                                    <br/>
                                    <strong>{s name=yellowcube/details/articles/form/origin}Country of Origin{/s}</strong>
                                    : {$position.origin}
                                    <br/>
                                {/if}
                            </td>
                ...
                <table width="300px" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td align="right" width="100px"
                            class="head">{s name="DocumentIndexTotalNet"}Gesamtkosten Netto:{/s}</td>
        ...
        <table style="height: 90px;" border="0" width="100%">
            ...
            <tr valign="top">
                ...
                <td style="width: 25%;padding-left:10px;">
                    ...
                    <p>
                        <span style="font-size: small;">{s name="DocumentFooterAgb"}Gerichtsstand ist Musterstadt


                                <br/>


Erfüllungsort Musterstadt


                                <br/>


Gelieferte Ware bleibt bis zur vollständigen Bezahlung unser Eigentum{/s}</span>
                    </p>
                </td>
                <td style="width: 25%;padding-left:10px;">
                    <p>
