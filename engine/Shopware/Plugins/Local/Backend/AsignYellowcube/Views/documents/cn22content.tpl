...
{foreach from=$Pages item=postions name="pagingLoop" key=page}
    <table cellpadding="0" cellspacing="0" border="0" class="main-table">
        <tbody valign="top">
        <tr class="thead">
            <td class="line-top line-left line-bottom"><img width="80"
                                                            src="{$smarty.session.Shopware.pluginPath|cat:'cn22_logo.jpg'}"
                                                            alt=""/></td>
        ...
        <tr>
            <td colspan="3" align="right" class="line-bottom padd-none line-left">
                <table cellpadding="" cellspacing="0" border="0">
                    <tr>
                        <td class="paddlr-5" width="120">{s name=yellowcube/print/cn22/param_1}Cadeau
                                <br/>
                                Geschenk
                                <br/>
                                Gift{/s}</td>
                        <td class="paddlr-5">{s name=yellowcube/print/cn22/param_2}Echantillon commercial
                                <br/>
                                Warenmuster
                                <br/>
                                Commercial sample{/s}</td>
                        <td class="paddlr-5" width="80">{s name=yellowcube/print/cn22/param_3}Documents
                                <br/>
                                Dokumente
                                <br/>
                                Documents{/s}</td>
                        <td class="paddlr-5" width="" align="center"><h1>X</h1></td>
                        <td class="paddlr-5 line-right">{s name=yellowcube/print/cn22/param_4}Autre
                                <br/>
                                Andere
                                <br/>
                                Other{/s}</td>
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%" class="article-table">
                    ...
                    {foreach from=$postions item="position" key="number" name="positions"}
                        {if $smarty.foreach.positions.iteration <= 5}
                            <tr>
                                <td class="line-bottom line-right paddlr-5">{$position.quantity}
                                    x {$position.name|nl2br}</td>
                                <td class="line-bottom line-right paddlr-5">
                    ...
                    <tr>
                        ...
                        <td class="line-bottom line-right paddlr-5"
                            align="right">{$Order._order.invoice_shipping_net|currency}</td>
                    </tr>
                    <tr>
                        ...
                        <td class="line-right paddlr-5"
                            valign="middle">{if $fTotalWeight < 0}0.0{else}{$fTotalWeight}{/if}kg
                        </td>
        ...
        <tr>
            <td colspan="3" class="line-bottom line-right line-left paddlr-5">
                {s name=yellowcube/print/cn22/declare}
                    Je certifie que les renseignements donnés dans la présente déclaration sont exacts et que cet envoi ne contient
                    <br>
                    aucun objet dangereux ou interdit par la réglementation postale ou douanière. • Ich bestätige hiermit, dass die
                    <br>
                    Angaben in der vorliegenden Deklaration richtig sind und dass die Sendung keine durch die Post-oder
                    <br>
                    Zollvorschriften verbotenen oder gefährlichen Gegenstände enthält.• I, the undersigned, whose name and
                    <br>
                    address are given on the Item, certify that the particulars given in the declaration are correct and that this Item
                    <br>
                    does not contain any dangerous article or articles prohibited by legislation or by postal ort customs regulations.
                {/s}
            </td>
        </tr>
        <!-- date and signature -->
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td width="70" align="center" class="paddlr-5">
                            <img width="40" src="{$smarty.session.Shopware.pluginPath|cat:'owner_signature.jpg'}"
                                 alt=""/>
                        </td>
                    </tr>
                </table>
